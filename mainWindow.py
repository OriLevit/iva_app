...
class MainWindow(CustomWindow.Window):
    ...
    def add_widgets(self, username):
        ...
        title_label.config(bg="#525050", fg="white", font=("Verdana", 18, "bold"))

        disclaimer_label = tkinter.Label(master=main_frame, text="הנתונים מעודכנים לפי אתר איגוד הכדורעף *")
        disclaimer_label.place(x=5, y=5)
        disclaimer_label.config(bg="#525050", fg="white", font=("Ariel", 8))

        leaderboard_frame = tkinter.Frame(main_frame, width=250, height=450, background="#949191")
        leaderboard_frame.grid(column=2, row=2,pady=15,padx=21)
        ...
        leaderboard_title.config(bg="#949191", fg="white", font=("Ariel", 14, "bold"))
        leaderboard_title.grid(row=0, column=1, pady=10)

        upcoming_frame = tkinter.Frame(main_frame, width=250, height=450, background="#949191")
        upcoming_frame.grid(column=1, row=2,pady=15,padx=21)
        ...
        upcoming_title.config(bg="#949191", fg="white", font=("Ariel", 14, "bold"))
        upcoming_title.grid(row=0, column=1, pady=10)

        previous_frame = tkinter.Frame(main_frame, width=250, height=450, background="#949191")
        previous_frame.grid(column=0, row=2,pady=15,padx=21)
        ...
        previous_title.config(bg="#949191", fg="white", font=("Ariel", 14, "bold"))
